...
"[project]/frontend/app/forgot-password/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ForgotPasswordPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/auth/forgot-password', {
                email
            });
            setSent(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('If this email exists, a reset link has been sent.');
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.response?.data?.message || 'Request failed');
        } finally{
            setLoading(false);
        }
    };
...
_s(ForgotPasswordPage, "egEkpSY7JzGzY3LHgYXUCcZ9tU8=", false, function() {
    return [
...
//# sourceMappingURL=frontend_93165b69._.js.map