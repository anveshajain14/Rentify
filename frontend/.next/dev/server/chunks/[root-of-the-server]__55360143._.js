...
async function GET(req, { params }) {
    try {
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(resolvedParams.id).populate('seller', 'name avatar bio location joinedAt');
        if (!product) {
...
async function PUT(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const resolvedParams = typeof params.then === 'function' ? await params : params;
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(resolvedParams.id);
        if (!product) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Product not found'
            }, {
        ...
        const updatedProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(resolvedParams.id, data, {
            new: true
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(resolvedParams.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__55360143._.js.map